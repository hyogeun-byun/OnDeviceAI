...
class TestR01MultiCameraWebSocket(unittest.TestCase):
    def test_camera_workers_connect_independently_by_id(self):
        ...
        assert_contains(
            self,
            "src/program_server/app/main.py",
        ...
        write_requirement_log(
            ...
            "expected_runtime_logs=test-results/program_camera_worker/requirements/R-01-multi-camera-websocket-server.log, test-results/program_camera_worker/requirements/R-01-multi-camera-websocket-camera-<CAMERA_NO>.log",
            "expected_metric_logs=test-results/program_camera_worker/requirements/R-01-multi-camera-websocket-camera-<CAMERA_NO>-metrics.jsonl",
