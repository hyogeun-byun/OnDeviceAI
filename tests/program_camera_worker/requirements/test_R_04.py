...
class TestR04ThreadSeparation(unittest.TestCase):
    def test_capture_frame_sending_and_pose_inference_have_separate_threads(self):
        assert_contains(
            self,
            "src/program_camera_worker/app/main.py",
            "def capture_loop",
        ...
        write_requirement_log(
            ...
            "expected_runtime_logs=test-results/program_camera_worker/requirements/R-04-threaded-capture-frame-pose-camera-<CAMERA_NO>.log",
            "expected_metric_logs=test-results/program_camera_worker/requirements/R-04-threaded-capture-frame-pose-camera-<CAMERA_NO>-metrics.jsonl",
