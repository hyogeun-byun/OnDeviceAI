...
class TestR17GameWebSocketBroadcast(unittest.TestCase):
    def test_game_state_is_broadcast_at_10hz(self):
        ...
        assert_contains(self, "src/program_server/app/api/game_routes.py", '@router.websocket("/ws")')
        write_requirement_log(
            ...
            "expected_runtime_logs=test-results/program_server/requirements/R-17-game-websocket-10hz-sync-server.log",
