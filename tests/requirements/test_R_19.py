...
class TestR19NoLlmInPlayingPath(unittest.TestCase):
    def test_playing_gauge_update_does_not_call_llm_generation(self):
        ...
        write_requirement_log(
            ...
            "expected_runtime_logs=test-results/requirements/R-19-no-llm-playing-path-server.log, test-results/requirements/R-19-no-llm-playing-path-camera-<CAMERA_NO>-metrics.jsonl",
        )
