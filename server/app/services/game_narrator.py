...
def intro_tour(theme: str = "") -> list[dict[str, str]]:
    return [
        ...
        {
            "target": "gauge",
            "text": "그리고 가운데 이 게이지! 여러분의 동작이 얼마나 똑같은지 실시간 점수예요. 구십 점만 넘으면 바로 통과, 다음 제시어로 넘어갑니다!",
        },
        {
            "target": "hint",
            "text": "한 제시어를 십 초 동안 못 맞히면, 서로의 카메라 화면을 잠깐 크게 보여드려요! 그 모습을 보고 동작을 맞춰가세요!",
        },
        {
            "target": "ready",
            "text": "제한시간은 단 일 분! 그 안에 제시어를 최대한 많이 맞히면 됩니다. 구십 점 넘으면 바로 통과, 다음 제시어로! 십 초 동안 못 맞히면 서로의 모습을 큰 화면으로 잠깐 보여드리고, 그래도 이십 초 안에 못 맞히면 자동으로 다음 제시어로 넘어갑니다! 자, 어떤 카테고리로 할지 골라볼까요?",
        },
    ]
